...
OpenSMTPd filter which rejects eMails based on configurable subject patterns.
...
```
opensmtpd-filter-subjectstrings [literal|regex PATTERNS_FILE ...]
```
...
Every non-empty line is a phrase to disallow in eMails' subject.
